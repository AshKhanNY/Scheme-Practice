...
(define (spreadDigit n)
  (if (< n 100)
      ...
      ; second to last digit and the last digit
      (abs (- (modulo n 10) (modulo (quotient n 10) 10)))
      ; swaps the last digit and the second to last digit
      ; if the second to last digit is greater than the last digit
      (let ((m (if (> (modulo (quotient n 10) 10) (modulo n 10))
                   (+ (* (quotient n 100) 100) (* (modulo n 10) 10) (modulo (quotient n 10) 10))
                   n)))
        ...
        (cond ((< (modulo (quotient m 100) 10) (modulo (quotient m 10) 10)) (spreadDigit (+ (* (quotient m 100) 10)   (modulo m 10))))
              ((> (modulo (quotient m 100) 10) (modulo m 10))               (spreadDigit (+ (* (quotient m 1000) 100) (* (modulo (quotient m 10) 10) 10) (modulo (quotient m 100) 10))))
              ; removes third to last digit if it is equal to either the smallest or biggest so far
              (else                                                         (spreadDigit (+ (* (quotient m 1000) 100) (* (modulo (quotient m 10) 10) 10) (modulo m 10))))))))
